...
function loadPagination(pagno) {
	$.ajax({
		url: `${base_url}frontend/galeri/loadRecord/${pagno}`,
		type: "POST",
		dataType: "json",
		data: {
...
function loadPaginationByTag(pagno, tag) {
	...
	$.ajax({
		url: `${base_url}galeri/loadRecord/${pagno}`,
		type: "POST",
		dataType: "json",
		data: {
			saerchText: $("#searchText").val(),
                        ...
                        <div class="blog_section">
                            ...
                            <div class="blog_feature_cantant">
                                ...
                                <div class="bottom_info">
                                    <div class="pull-left"><a class="btn sqaure_bt" href="${base_url}galeri/view/${id}/${slug}">Read More<i class="fa fa-angle-right"></i></a></div>
