                    ...
                    <form id="news_form" action="<?= base_url('news/save') ?>">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title text-left">Create News</h3>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="news_tags" name="news_tags" data-role="tagsinput" placeholder="News Tags">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">News Body</label>
                                            <textarea type="text" class="form-control editor" id="news_body" name="news_body" placeholder="News Body"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
