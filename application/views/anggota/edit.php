			...
			<div class="row">
				<div class="col-12">
					<div class="card">
						...
						<!-- /.card-header -->
						<div class="card-body">
							<form action="<?= base_url('anggota/save_edit') ?>" id="form_register" class="form-horizontal">
									...
									<div class="col-md-12">
										<fieldset>
											<?php foreach ($data_edit as $edit) : ?>
												<script>
													var kota_edit = <?= json_decode($edit['kota_id']) ?>;
													var kec_edit = <?= json_decode($edit['kecamatan_id']) ?>;
												</script>
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label>Username <span class="red">*</span></label>
															<input name="username" id="username" type="text" class="form-control" value="<?= $edit['user_username'] ?>">
															<input name="old_username" id="old_username" type="text" class="form-control" hidden readonly value="<?= $edit['user_username'] ?>">
															<input name="user_id" id="user_id" type="text" class="form-control" hidden readonly value="<?= $edit['user_id'] ?>">
															<input name="developer_id" id="developer_id" type="text" class="form-control" hidden readonly value="<?= $edit['developer_id'] ?>">
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															<label>Email <span class="red">*</span></label>
															<input name="email" id="email" type="email" class="form-control" value="<?= $edit['user_email'] ?>">
															<input name="old_email" id="old_email" type="email" class="form-control" hidden readonly value="<?= $edit['user_email'] ?>">
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<input name="developer_name" id="developer_name" type="text" class="form-control" value="<?= $edit['developer_name'] ?>">
														</div>
													</div>
													<div class="col-md-12">
														<div class="form-group">
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<input name="loc_lng" id="loc_lng" type="text" readonly hidden class="form-control" value="<?= $edit['developer_lng'] ?>">
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<input name="phone" id="phone" type="text" class="form-control" value="<?= $edit['developer_phone'] ?>">
															<input name="old_phone" id="old_phone" type="text" class="form-control" hidden readonly value="<?= $edit['developer_phone'] ?>">
														</div>
													</div>
												</div>
											<?php endforeach; ?>
								...
								<div class="panel-heading display-table">
									<div class="display-tr">
										<h3 class="panel-title display-td">Dokumen</h3>
										<div class="display-td"> </div>
									</div>
								</div>
								<div class="panel-body">
