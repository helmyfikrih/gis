...
class Galeri extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ((!in_array($this->data['menu_allow'] . '_read', $this->data['user_allow_menu']))) {
            ...
            $this->template->load('default', 'galeri/index', $data);
        }
    }
    ...
    function getList()
    {
        ...
        foreach ($list as $field) {
            ...
            if (array_intersect(array($this->data['menu_allow'] . '_update'), $this->data['user_allow_menu'])) {
                $btnEdit = '<span><a class="btn btn-outline-info btn-sm" href="' . base_url('galeri/edit/' . $field->news_id . '/' . $field->news_slug) . '"><i class="fa fa-edit"></i> Edit</a></span>';
            }
            ...
            $btnView = '<span><a class="btn btn-outline-success btn-sm" href="' . base_url('galeri/view/' . $field->news_id . '/' . $field->news_slug) . '"><i class="fa fa-eye"></i> View</a></span>';
    ...
    function create()
    {
        ...
        if ((!in_array($this->data['menu_allow'] . '_create', $this->data['user_allow_menu']))) {
            ...
            $this->template->load('default', 'galeri/create', $data);
        }
    }
    ...
    function edit()
    {
        ...
        if ((!in_array($this->data['menu_allow'] . '_update', $this->data['user_allow_menu']))) {
            ...
            $this->template->load('default', 'galeri/edit', $data);
        }
    }
