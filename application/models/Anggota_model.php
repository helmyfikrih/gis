...
class Anggota_model extends CI_Model
{
	...
	{
		$this->db->select("*, u.user_id, kec.kecamatan_id, kota.kota_id, dd.developer_id, r.register_id");
		$this->db->from('gis_user u');
		...
		$this->db->join("gis_kecamatan kec", "kec.kecamatan_id=dd.kecamatan_id", 'left');
		$this->db->join("gis_kota kota", "kota.kota_id=kec.kota_id", 'left');
		$this->db->where($cond);
