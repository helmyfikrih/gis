...
class Data_kecamatan_model extends CI_Model
{
    ...
    var $order = array('kecamatan_id' => 'asc'); // default order
    ...
    {
        return $this->db->insert('gis_kecamatan', $data);
    }

    function update($data, $cond)
    {
        $this->db->where($cond);
        return $this->db->update('gis_kecamatan', $data);
    }

    function getOne($id)
    {
        $this->db->where('kecamatan_id', $id);
        return $this->db->get('gis_kecamatan')->result_array();
    }

    function deleteData($data)
    {
        $this->db->where($data['cond']);
        return $this->db->delete('gis_kecamatan');
    }
}
